		...
		<form action="ex07-action.jsp">
			...
			<p>
				<select name="category" required>
					...
					<option value="boonsik.png">분식
					</option>
					<option value="chicken.png">치킨
					</option>
					<option value="donggas.png">돈까스,회,일식
					</option>
					<option value="jjajang.png">중국집
					</option>
					<option value="nightfood.png">야식
					</option>
					<option value="pizza.png">피자
					</option>
					<option value="zokbal.png">족발,보쌈
					</option>
					<option value="zzim.png">찜,탕
					</option>

...
<body>
	...
	<h3>redirect : 클라이언트에게 이동할 주소를 보내주고, 클리이언트가 새로 요청하게 한다</h3>
	...
	<table border="1" cellpadding="10" cellspacing="0">
		...
		<tr>
			<td>requse.getRequestDispatcher(String uri).forward(requset,
				response)</td>
			<td>
				<ul>
					...
					<li>requset, response가 유지된다 (A에서 setAttribute 하면, B에서
						getAttribute 할 수 있다)</li>

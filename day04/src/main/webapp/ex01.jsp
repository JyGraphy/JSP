...
<body>
	...
	<h3>스크립틀릿에서 따로 생하지 않아도 참조할 수 있는 객체</h3>
	<table>
		<tr>
			<td>request</td>
		...
		<tr>
			<td>out</td>
			<td>response에 으압 내용을 기록하기 위한 outputstream</td>
...
//	out.print("<p> exception :" + (pageContext.getException() == exception) + "</p>");
	...
	%>
	<h3>EL Tag pageContext만으로 나머지 내장객체에 접근하는 역할을 수행한다</h3>
	
	<h4>request.getCintextPath() : ${pageContext.request.servletContext }</h4>
	<h4>request.getCintextPath() : <%=request.getContextPath() %></h4>
</body>
</html>
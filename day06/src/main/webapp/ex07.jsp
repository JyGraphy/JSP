...
<body>
	...
	<h3>JSP에서 자주 사영하는 표준 태그 라이브러리</h3>
	
	<ul>
		<li>JSTL Core: 변수(attribute) 선언, if, forEach 등 스크립틀릿 코드르 대신하는 태그</li>
		<li>JSTL functions : length, substring 등 추가적인 함수를 사용하기 위한 태그</li>
		<li>JSTL Format : 숫자, 날짜 및 시간 등의 서식을 지정하기 위한 태그</li>
		<li>JSTL Sql : JSP에서 SQL문을 이영하여 DB와 상호작용하기 위한 태그</li>
	...
	<ol>
		...
		<li>action태그는 기번 JSP 문법을 확장하여 여러 태그를 제공했지만, 부족한점이 있엇다</li>
		<li>여러 개발자들이 자신만의 태그를 생성하여 사용하기 시작했다 (Tag Library)</li>
		<li>같은, 비슷한 기능을서로 다르게 사용하면서 표준이 필요해진다</li>

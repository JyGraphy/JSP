...
<body>
	...
	<form action="add-action.jsp">
		...
		<p><input type="text" name="artist_name" placeholder="아티스트이름"></p>
		<p><input type="text" name="album_name" placeholder="앨범이름"></p>
		<p><input type="text" name="name" placeholder="노래제목"></p>
		<p><input type="text" name="genre" placeholder="장르"></p>
		<p><input type="text" name="playTime" placeholder="플레이시간"></p>
		
		<p>
			<select name="isTitle" required="required">

...
<body>
	...
	<h3>스크립틀릿 내부에서는 객체를 별로로 생성하지 않아도 request/response에 접근할 수 있다</h3>
	<h3>request/response는 JSP 내장객체에 해당한다 (별도 생성이 필요 없음)</h3>
	...
	<table>
		...
		<!-- 서버의 주소 -->
			...
			<!--  상숑하는 형태가 HashMap <String, Object>과 유사하다 -->
			<tr>
				<td>request.setAttribute(String name, Object o)</td>
				<td>requset 내장객체에 자바 객체를 저장한다</td>
			...
			<tr>
				...
				<td>requset 내장객체에 자바 객체를 이름으로 불러와서 Object로 반환한다</td>
			...
			<tr>
				...
				<td>
					...
					클라이너트의 입력값이므로, 서버에서 set하는 메서드는 없다
				</td>

...
<body>
	...
	<fieldset>
			<legend>String request.getParmater(String name)</legend>
	...
	<fieldset>
		<legend>String[] values = request.getParameterValues(String name))</legend>
		<h4>하나의 이름으로 여러 값을 일력받을 때 사용한다 (checkbox)</h4>
		<form action="">
		<p>
	...
	<fieldset>
		<legend>Map&lt;String, String[]> request.getParmeterMap()</legend>
	...
	<fieldset>
		...
		<jsp:useBean id="ob" class="food.FoodDTO"/>	<%--빈 객체를 생성한다 FoodDTO ob = new FoodDTO--%> 

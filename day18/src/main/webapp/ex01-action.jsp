...
<body>
	...
	<%	
		// 사용자가 파일을 첨불하여 제출하는 상황이라면
		// 첨부파일의 크기를 미리 예측할 수 있다
		// 큰 용향의 파일을 단일 객체로 전송할 수 없기 때문에, 여러 파트로 분할하여 전송한 후 재조립한다
		...
		// com.oreilly.servlet.MultipartRequset (cos.jar)
	...
	<%
		...
		// 기존의 내장객체 requset와 몇가지 옵션을 추가로 전달받아서
	...
	<div>
		<img alt="" src="upload/<%=f.getName()%>"  height="150">
	</div>
